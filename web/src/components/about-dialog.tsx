	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogPopup className="max-w-md">
				<DialogHeader>
					<DialogTitle>关于 AutoSecrets</DialogTitle>
					<DialogDescription>
						AutoSecrets 是一个轻量级密钥托管服务。
					</DialogDescription>
				</DialogHeader>
				<DialogPanel>
					<div className="space-y-5">
									...
									{health.isPending ? (
										...
										<div className="flex shrink-0 items-center gap-1.5">
											<Badge variant="secondary" className="font-mono">
												{formatVersion(health.data.version)}
											</Badge>
						...
						<Button
							variant="outline"
							className="h-auto w-full justify-between gap-2 p-3 text-sm font-medium"
